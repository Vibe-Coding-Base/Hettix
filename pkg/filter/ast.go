...
func init() {
	...
	gob.RegisterName("github.com/Vibe-Coding-Base/Hettix/pkg/search.PrefixExpression", PrefixExpression{})
	gob.RegisterName("github.com/Vibe-Coding-Base/Hettix/pkg/search.InfixExpression", InfixExpression{})
	gob.RegisterName("github.com/Vibe-Coding-Base/Hettix/pkg/search.StringLiteral", StringLiteral{})
	gob.RegisterName("github.com/Vibe-Coding-Base/Hettix/pkg/search.RegexpLiteral", RegexpLiteral{})
}
